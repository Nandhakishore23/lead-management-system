...
//   city: '', state: '', source: 'other', status: 'new', score: 0, lead_value: 0, is_qualified: false, last_activity_at: ''
// };
...
//         setForm({
//           ...data,
//           last_activity_at: data.last_activity_at ? new Date(data.last_activity_at).toISOString().slice(0, 16) : ''
//         });
//       } catch (err) {
...
//   return (
//     <form onSubmit={submit} style={{ maxWidth: 640, margin: 20 }}>
//       <h2>{editMode ? 'Edit' : 'Create'} Lead</h2>

//       <div><input placeholder="First name" value={form.first_name} onChange={e => handle('first_name', e.target.value)} required /></div>
//       <div><input placeholder="Last name" value={form.last_name} onChange={e => handle('last_name', e.target.value)} required /></div>
//       <div><input placeholder="Email" value={form.email} onChange={e => handle('email', e.target.value)} required /></div>
//       <div><input placeholder="Phone" value={form.phone} onChange={e => handle('phone', e.target.value)} /></div>
//       <div><input placeholder="Company" value={form.company} onChange={e => handle('company', e.target.value)} /></div>
//       <div><input placeholder="City" value={form.city} onChange={e => handle('city', e.target.value)} /></div>
//       <div>
//         <label>Source</label>
...
//       <div><label>Score</label><input type="number" min="0" max="100" value={form.score} onChange={e => handle('score', Number(e.target.value))} /></div>
//       <div><label>Lead Value</label><input type="number" value={form.lead_value} onChange={e => handle('lead_value', Number(e.target.value))} /></div>
//       <div>
//         <label>Last activity</label>
//         <input type="datetime-local" value={form.last_activity_at} onChange={e => handle('last_activity_at', e.target.value)} />
//       </div>
//       <div>
//         <label>
